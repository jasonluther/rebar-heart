...
def rand_hsv():
    # Blue Hue: 230-245 (out of 360)
    hsv = fancy.CHSV(random.uniform(230.0/360.0, 245.0/360.0), random.uniform(0.8, 1.0), 0.2)
    return hsv
...
while True:
    ...
    if (dir != last_dir):
        ...
        tail_hue = random.uniform(30.0/360.0, 45.0/360.0)
        if (dir == "edge"):
